...
from accounts.fomu import PasswordChangingForm
...
def not_found(request):
    ctx = {'message': 'Samahani ukurasa haupo!'}
    return render(request, 'pages/errors/404.html', ctx)
...
def UserLogin(request):
    if request.method == "POST":
        ...
        if user is not None:
            ...
            messages.info(request, 'Jina la mtumiaji au nywila sio sahihi')
