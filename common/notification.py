...
logger = logging.getLogger('mtaawangu')
...
class MtaaWanguNotificationBodies:
    """Default set of notifications for MtaaWangu.
    ...
    NewOrder = NotificationBody(
        ...
        template='sms/new_order_assigned.html',
    )
    ...
    ItemsReceived = NotificationBody(
        ...
        template='sms/purchase_order_received.html',
    )
    ...
    ReturnOrderItemsReceived = NotificationBody(
        ...
        template='sms/return_order_received.html',
    )
